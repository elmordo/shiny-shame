...
class ExperimentController extends Zend_Controller_Action {
	...
	public function postAction() {
        ...
        if ($this->_request->isPost()) {
            ...
            if ($form->isValid($this->_request->getParams())) {
                ...
                $tableExperiments = new Application_Model_Experiments();
                $experiment = $tableExperiments->createExperiment($form->getValues(true), 
    ...
    public static function findExperiment($id) {
        ...
        if (is_null($experiment)) throw new Zend_Db_Table_Exception(sprintf("Experiment #%s not found", $id));
