...
CREATE TABLE `collections` (
  ...
  CONSTRAINT `collections_ibfk_3` FOREIGN KEY (`group_id`) REFERENCES `groups` (`id`) ON DELETE SET NULL,
  CONSTRAINT `collections_ibfk_1` FOREIGN KEY (`experiment_id`) REFERENCES `experiments` (`id`) ON DELETE CASCADE,
  CONSTRAINT `collections_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
INSERT INTO `collections` VALUES (1,2,'test','test','sjx',1,1,'rwdr--r--'),(2,1,'kolekce',NULL,NULL,1,NULL,'rwdr--r--'),(3,2,'collection 56',NULL,NULL,1,2,'rwdr--r--');
...
-- Dump completed on 2014-01-07  1:28:47
